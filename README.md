...
#### 1.2.1. [Способы поиска нужного HTML-элемента.](./element-search/)

#### 1.2.2. [Способы поиска нужного HTML-элемента (тренажёр).](./element-search_trainer/)
...
#### 2.2.1. [Работа с HTML-формами.](./html-forms/)

#### 2.2.2. [Работа с HTML-формами (тренажёр).](./html-forms_trainer/)
