...
function resetAll() {
  ...
  // localStorage.clear(); // NOTE: Как при .clear() добиться синхронизации данных в соседней вкладке ???
}
...
// получение логина и пароля из localStorage:
